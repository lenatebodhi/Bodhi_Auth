...
class CoursesView(viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        queryset =  Courses.objects.filter(is_active=1,is_deleted=0,).order_by("-id")
        return queryset
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({'results':serializer.data,
                            "message" : message},status=HTTP_200_OK)
...
class CoursesDetailsView(viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        queryset =  CourseDetails.objects.filter(is_active=1,is_deleted=0,).order_by("-id")
        return queryset
...
class ModulesView(viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        queryset =  Module.objects.filter(is_active=1,is_deleted=0,).order_by("-id")
        return queryset
...
class LessonView(viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        queryset =  Lesson.objects.filter(is_active=1,is_deleted=0,).order_by("-id")
        return queryset
